export default function privacy() {
  return (
    <main className="w-full px-4 lg:px-6 max-w-7xl mx-auto py-16">
      <div className="flex flex-col gap-4">
        <h1 className="text-transparent bg-clip-text bg-gradient-to-t from-[#AA823D] via-[#EFE288] to-[#D1B85A] text-5xl font-bold mb-12">
          Privacy Policy
        </h1>
        <div className="text-neutral-100 text-base font-normal">
          ...
          <br />
          <br />
          Disclosure of Your Personal Data Business Transactions If the Company
          ...
          property of the Company Prevent or investigate possible wrongdoing in
          connection with the Service Protect the personal safety of Users of
          the Service or the public Protect against legal liability Security of
          Your Personal Data The security of Your Personal Data is important to
          ...
          from anyone under the age of 13. If You are a parent or guardian and
          ...
          <br />
          We use YouTube API Services as part of our platform functionality. For
          transparency, you can view Google’s Privacy Policy at
          http://www.google.com/policies/privacy.
          <br />
          The YouTube API client stores data for a maximum of 48 hours solely
          for validation purposes, after which it is permanently deleted.
          <br />
          You may revoke our access to your data at any time through the Google
          security settings page at https://security.google.com/settings.
          <br />
          If you have any questions or concerns regarding the Privacy Policy,
          please contact us at: appxdev1@gmail.com
        </div>
      </div>
    </main>
  );
